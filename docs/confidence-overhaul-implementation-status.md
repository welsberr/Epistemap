...
| E2 evidence ledger and Bayesian assessment | partial | Bayesian weighting prefers typed edge/source assessments and preserves explicit zero; W1 evidence ledger models, deterministic serialization/hash helpers, identity derivation, and validation exist locally | Graph-to-ledger conversion, deterministic deduplication, source-family handling policy application, revision-edge separation in conversion, and reconstructable assessment output |
